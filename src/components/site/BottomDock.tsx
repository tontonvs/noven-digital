...
export function BottomDock() {
  ...
  return (
    <div
      className="fixed bottom-3 left-3 z-40 hidden flex-col items-center gap-1 rounded-[2rem] rounded-bl-[2.75rem] bg-white/92 p-2 shadow-md backdrop-blur-md md:flex"
      role="group"
    ...
    >
      <button
        ...
        className={`bouncy grid size-11 place-items-center rounded-full hover:scale-110 active:scale-95 ${
          mode === "dark"
            ? "bg-slate-900/90 text-white shadow-inner backdrop-blur-xl"
      ...
      <button
        ...
        className={`bouncy grid size-11 place-items-center rounded-full hover:scale-110 active:scale-95 ${
          mode === "light" ? "bg-slate-900 text-white" : "text-slate-500 hover:bg-black/5"
        }`}
      >
        <Sun size={19} fill={mode === "light" ? "currentColor" : "none"} />
      </button>

      <span className="my-0.5 h-px w-6 bg-slate-300/70" />
      ...
      <a
        ...
        className="bouncy group grid size-11 place-items-center rounded-full bg-white text-slate-900 hover:scale-110 hover:bg-slate-900 hover:text-white active:scale-95"
      >
