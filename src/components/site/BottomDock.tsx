  ...
  return (
    ...
    >
      <button
        ...
        className={`bouncy grid size-9 place-items-center rounded-full hover:scale-110 active:scale-95 ${
          mode === "dark"
      ...
      <a
        ...
        className="bouncy group grid size-9 place-items-center rounded-full text-foreground hover:scale-110 hover:bg-foreground/5 active:scale-95"
      >
