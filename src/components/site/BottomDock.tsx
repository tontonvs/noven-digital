...
export function BottomDock() {
  ...
  return (
    <div
      className="fixed bottom-6 left-6 z-40 hidden flex-col items-center gap-1 rounded-full bg-card/92 p-1.5 shadow-md backdrop-blur-md md:flex"
      role="group"
    ...
    >
      <button
        ...
        className={`bouncy grid size-8 place-items-center rounded-full hover:scale-110 active:scale-95 ${
          mode === "dark"
      ...
      <a
        ...
        className="bouncy group grid size-8 place-items-center rounded-full text-foreground hover:scale-110 hover:bg-foreground/5 active:scale-95"
      >
