...
export function BottomDock() {
  ...
  return (
    <div
      className="fixed z-40 hidden flex-col items-center gap-1 bg-card/92 p-2 shadow-md backdrop-blur-md md:flex"
      style={{
        left: B,
        bottom: B,
    ...
    >
      {/* Shoulder flare — blends the dock's top-left into the bare vertical bezel line above it */}
      <div
      ...
      <a
        ...
        className="bouncy group grid size-11 place-items-center rounded-full bg-card text-foreground hover:scale-110 hover:bg-foreground hover:text-background active:scale-95"
      >
